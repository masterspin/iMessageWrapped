        ...
        <div className="px-3 md:px-3 lg:container lg:mx-auto lg:py-4">
          ...
          <div className="typing-indicator items-center">
            ...
            <div className="flex items-center justify-end">
              ...
              <div className="peer-checked:translate-x-0 fixed inset-0 w-[calc(100%-4.5rem)] translate-x-[-100%] shadow-xl transition duration-300 lg:border-r-0 lg:w-auto lg:static lg:shadow-none lg:translate-x-0 font-white">
                <div className="flex flex-col h-full justify-between lg:items-center lg:flex-row">
                  <ul className="px-6 pt-32 text-gray-700 space-y-8 md:px-12 lg:space-y-0 lg:flex lg:space-x-12 lg:pt-0">
                    <li className="pb-2 group relative before:absolute before:inset-x-0 before:bottom-0 before:h-2 before:origin-right before:scale-x-0 before:bg-zinc-300 before:transition before:duration-200 hover:before:origin-left hover:before:scale-x-100">
                      <Link className='font-bold text-2xl' href={ROUTES.ABOUT} style={{color: "#39ff5a"}}>About</Link>
                    </li>
                  </ul>
                </div>
              </div>
